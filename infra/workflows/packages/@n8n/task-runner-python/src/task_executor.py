...
try:
    ...
    ProcessType = ForkServerProcess
except (ImportError, ValueError):
    # Fallback for Windows (spawn)
    import multiprocessing
    MULTIPROCESSING_CONTEXT = multiprocessing.get_context("spawn")
    ProcessType = multiprocessing.Process
...
class TaskExecutor:
    ...
    def create_process(
        ...
        query: Query = None,
    ) -> tuple[ProcessType, PipeConnection, PipeConnection]:
    ...
    @staticmethod
    def stop_process(process: ProcessType | None):
