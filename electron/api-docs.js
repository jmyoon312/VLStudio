/**
 * ViraLoop Studio API Documentation
...
export const openApiSpec = {
  openapi: '3.0.3',
  info: {
    title: 'ViraLoop Studio API',
    version: '1.0.0',
    description: `ViraLoop Studio Electron 앱의 HTTP API입니다.
...
\`\`\`bash
cd /path/to/ViraLoop Studio/mcp-server
npm install
\`\`\`
...
\`\`\`bash
claude mcp add --scope user --transport stdio viraloop -- node /path/to/ViraLoop Studio/mcp-server/index.js
\`\`\`
...
`,
  ...
  servers: [
    { url: 'http://127.0.0.1:3210', description: 'Local ViraLoop Studio' },
  ],
  tags: [
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    app: { type: 'string', example: 'ViraLoop Studio' },
                  },
                },
              },
            },
...
<head>
  <meta charset="UTF-8">
  <title>ViraLoop Studio API Docs</title>
