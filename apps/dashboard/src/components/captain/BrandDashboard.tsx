                        ...
                        <div className="space-y-4 py-2 text-xs">
                            ...
                            {quickNetworkProfile.proxy_mode === 'ISP_PROXY' && (
                                <div className="grid grid-cols-2 gap-3 mt-3 animate-in fade-in">
                                    ...
                                    <div className="space-y-1.5">
                                        <Label>포트</Label>
                                        <Input className="h-8 text-xs font-mono" value={quickNetworkProfile.proxy_port || ''} onChange={e => setQuickNetworkProfile({ ...quickNetworkProfile, proxy_port: e.target.value })} placeholder="1080" />
                                    </div>
                                </div>
                            )}
                        </div>
