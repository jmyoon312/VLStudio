                ...
                {stats && (
                    <div className="grid grid-cols-4 gap-3">
                        <div className="bg-card rounded-xl p-4 border border-border shadow-sm">
                            <div className="text-2xl font-black text-foreground">{stats.running || 0}</div>
                            <div className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mt-1">🔥 Running</div>
                        </div>
                        <div className="bg-card rounded-xl p-4 border border-border shadow-sm">
                            <div className="text-2xl font-black text-emerald-600">{stats.completed || 0}</div>
                            <div className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mt-1">✅ Completed</div>
                        </div>
                        <div className="bg-card rounded-xl p-4 border border-border shadow-sm">
                            <div className="text-2xl font-black text-indigo-600">{stats.pending || 0}</div>
                            <div className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mt-1">⏳ Pending</div>
                        </div>
                        <div className="bg-card rounded-xl p-4 border border-border shadow-sm">
                            <div className="text-2xl font-black text-purple-600">{stats.in_progress || 0}</div>
                            <div className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mt-1">📈 Day 1-6</div>
                        </div>
                    </div>
                )}
            </div>
                ...
                <div className="grid grid-cols-7 gap-2">
                    {[1, 2, 3, 4, 5, 6, 7].map(day => (
                        <div key={day} className="text-center">
                            <div className="bg-background rounded-xl p-2 border border-border/50 shadow-sm">
                                <div className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Day {day}</div>
