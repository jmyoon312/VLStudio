        ...
        <div className="flex flex-col h-full bg-slate-50 font-sans p-6 overflow-y-auto">
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-sm text-slate-500 font-medium mt-1">경쟁 채널 발굴 및 시그니처 DNA 분석</p>
                </div>
                <div className="flex items-center gap-3">
                    <div className="relative">
                        ...
                        <input 
                            ...
                            className="pl-9 pr-4 py-2 bg-white border border-slate-200 rounded-full text-sm font-medium focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all w-64 shadow-sm"
                        />
                    </div>
                    ...
                    <button 
                        ...
                        disabled={isScouting}
                        className="flex items-center gap-2 px-5 py-2 bg-indigo-600 text-white rounded-full text-sm font-black tracking-wide shadow-md shadow-indigo-200 hover:bg-indigo-700 hover:shadow-lg transition-all disabled:opacity-50"
                    >
            ...
            <div className="flex gap-6 h-full">
                ...
                <div className="w-72 bg-white rounded-2xl border border-slate-200 shadow-sm p-5 flex flex-col">
                    <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-4">카테고리 분류</h3>
                    <div className="flex-1 border-2 border-dashed border-slate-100 rounded-xl flex items-center justify-center">
                        <span className="text-sm text-slate-400 font-medium">카테고리 트리 로딩 중...</span>
                    </div>
                </div>

                {/* Right Panel: Candidate Grid */}
                <div className="flex-1 bg-white rounded-2xl border border-slate-200 shadow-sm p-6 flex flex-col">
                    <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-4">발굴된 채널 후보</h3>
                    <div className="flex-1 border-2 border-dashed border-slate-100 rounded-xl flex items-center justify-center">
                        <span className="text-sm text-slate-400 font-medium">AI가 추천하는 채널 리스트가 여기에 표시됩니다.</span>
                    </div>
                </div>
            </div>
        </div>
