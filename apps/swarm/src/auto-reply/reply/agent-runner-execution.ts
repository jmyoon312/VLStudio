                ...
                onReasoningStream:
                  params.typingSignals.shouldStartOnReasoning || params.opts?.onReasoningStream
                    ? async (payload) => {
                        ...
                        // [HERMES OPTIMIZATION] Reasoning signals disabled
                ...
                onAgentEvent: async (evt) => {
                  ...
                  if (evt.stream === "tool") {
                    ...
                    if (phase === "start" || phase === "update") {
                      // [HERMES OPTIMIZATION] Thinking signals disabled for direct response
                  ...
                  if (evt.stream === "compaction") {
                    ...
                    if (phase === "start") {
                      ...
                      if (params.opts?.onCompactionStart) {
                        ...
                        // [HERMES OPTIMIZATION] Compaction notice disabled
                        /*
