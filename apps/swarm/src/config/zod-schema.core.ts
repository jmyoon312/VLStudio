...
const ConfiguredProviderRequestTlsSchema = z
  .object({
    ca: SecretInputSchema.optional(),
    cert: SecretInputSchema.optional(),
    key: SecretInputSchema.optional(),
    passphrase: SecretInputSchema.optional(),
