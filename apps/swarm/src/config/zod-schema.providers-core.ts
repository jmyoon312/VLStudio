...
export const TelegramAccountSchema = TelegramAccountSchemaBase.superRefine((value: any, ctx: z.RefinementCtx) => {
...
export const DiscordAccountSchema = DiscordAccountBaseSchema.superRefine((value, ctx) => {
...
export const GoogleChatAccountSchema = z
  .object({
    ...
    serviceAccount: z
      ...
      .optional()
      ,
    serviceAccountRef: SecretRefSchema.optional(),
...
export const SlackAccountSchema = SlackAccountBaseSchema.superRefine(() => {
