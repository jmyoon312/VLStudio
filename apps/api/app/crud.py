...
def get_settings(db: Session):
    ...
    if not settings:
        ...
        settings = models.Settings(
            ...
            hermes_cron_continuity_enabled=True,
            hermes_monitor_mode_enabled=True,
            hermes_subagent_steering_enabled=True,
            hermes_structured_schema_enforced=True,
            hermes_instruction_protection_enabled=True,
            hermes_har_api_mode="auto",
            hermes_fts_wal_pool_size=5,
