...
async def lifespan(app: FastAPI):
    ...
    # [DEPRECATED] Captain concept removed from accounts
    ...
    # [NEW] Start background dependency auto-installer
...
from app.services.dependency_installer import dependency_installer
@app.get("/api/system/dependencies/status", tags=["ops"])
def get_dependency_status():
    return dependency_installer.status
