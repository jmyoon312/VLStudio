...
from app.routers import (
    ...
    bridge_config, bridge_config_v2, bridge_search, browser_profiles, 
...
app.include_router(infra.router, prefix="/api/infra", tags=["ops"])
...
app.include_router(n8n_integration.router, prefix="/api", tags=["automation"])
...
app.include_router(templates.router, prefix="/api/templates", tags=["creative"])
app.include_router(editor.router, prefix="/api/editor", tags=["creative"])
app.include_router(assets.router, prefix="/api/assets", tags=["assets"])
app.include_router(notebooklm_accounts.router, prefix="/api/notebooklm-accounts", tags=["infra"])
app.include_router(categories.router, prefix="/api/categories", tags=["assets"])
